...
public class TurtleSoup {
	...
	public static Set<Point> convexHull(Set<Point> points) {
		...
		convex.add(firstPoint);
		points2.remove(firstPoint);
		...
		do {
			...
			double targetdis = 0;
			for (Point p : points2) {
				double tempangle = calculateHeadingToPoint(0, (int) prePoint.x(), (int) prePoint.y(), (int) p.x(),
						(int) p.y());
				...
				else if (tempangle == targetangle && tempdis > targetdis) {
					targetdis = tempdis;
					targetPoint = p;
				}
			}
